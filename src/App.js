      ...
      <h2>Teachers</h2>
        <ul className="group">
          <li className="teacher">
            <img className="teacher-img" src="img/angie.png"/>
          ...
          <li className="teacher">
            <img className="teacher-img" src="img/nodestradamus.png"/>
            <h3>NodeStradamus</h3>
          ...
          <li className="teacher">
            <img className="teacher-img" src="img/geo.png"/>
            <h3>Geo 'Lo' Cation</h3>
          ...
          <li className="teacher">
            <img className="teacher-img" src="img/ecma.png"/>
